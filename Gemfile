...
gem "logstash-output-file", :github => "logstash-plugins/logstash-output-file", :branch => "feature/plugin-api-2_0"
...
gem "logstash-filter-json", :github => "logstash-plugins/logstash-filter-json", :branch => "feature/plugin-api-2_0"
